# 2D Lattice Boltzmann of von Karman Street & Quantitative analysis of the von Karman street

Two codes:

1. Lattice Boltzmann code (Python, .ipynb) to simulate flow past disc in 2D - shows von Karman streets of vorticities at Re around 100
...
It has a logical variable to save set of vorticity flow fields (in specified subdirectory that you will need to create), which you can then analyse with other .ipynb code.
